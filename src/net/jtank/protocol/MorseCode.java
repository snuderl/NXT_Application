 ...
 * </p>
 * <p>
 * Description: Used for translating Strings and characters to and from morse
 * code
 * </p>
 * 
 * <p>
 * An example of this class in use can be found in the Tank Software program
 * MorseCoder.
 * </p>
 * <p>
...
public class MorseCode {
	 ...
	 * 
	 * @param toEncode
	 *            The single character String to be encoded into Morse Code
	 ...
	 * 
	 * @param toEncode
	 *            The Single character of morse eg. ".-"
	 * @return The alphabetic representation of that character, eg. for ".-", it
	 *         is "a".
	 */
	...
	/**
	 * Converts a String of normal characters into a String of morse code
	 * characters
	 * 
	 * @param text
	 *            The String of text to be converted into morse.
	...
	/**
	 * Converts a String of morse code characters into a String of normal
	 * characters
	 * 
	 * @param text
	 *            The String of morse code characters, to be converted into
	 *            normal characters.
	...
	public static String stringFromMorse(String text) {
		...
		for (int i = 0; i < text.length(); i++) {
			...
			// If it encounters a space or new line, then it is the end of the
			...
			if (selected.equalsIgnoreCase(" ")
				...
				// If it is not a space or new line, add it to the current
				// character string
